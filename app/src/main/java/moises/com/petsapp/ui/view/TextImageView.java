package moises.com.petsapp.ui.view;
...
import moises.com.petsapp.tools.SavedState;
import moises.com.petsapp.tools.Utils;
...
public class TextImageView extends LinearLayout implements View.OnClickListener{
    ...
    public void setEnabled(boolean enabled){
        ...
        if(enabled)
            textView1.setTextColor(Utils.getColor(R.color.colorPrimaryText));
        else
            textView1.setTextColor(Utils.getColor(R.color.divider));
    }
